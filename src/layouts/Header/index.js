  ...
  return (
    <header style={{ background: 'white', padding: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
        ...
        <nav>
          <ul className='grid-container' style={{ listStyle: 'none', display: 'flex', margin: 0, padding: 0 }}>
            ...
            <li style={{ marginRight: '10px' }}><a href="#">
              <button style={{ padding: '10px', width: '202px', height:'51px', backgroundColor: '#1F94AA', color: 'white', border: 'none', borderRadius: '50px' }}>
                Get the Initio Kit
              </button>
            </a></li>
          </ul>
